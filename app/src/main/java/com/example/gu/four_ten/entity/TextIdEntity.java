...
public class TextIdEntity {
     ...
     * title : 那一抹流光
     * author : 孔龙
     * authorbrief : One作者，微博@孔龙loong。微信公众号：孔龙故事(konloong)
     * times : 6964
     * summary : 感谢作者授权发表。

     高考结束，在估分报志愿的阶段，回忆一下青春高中是我最难忘最难忘的一个经历。有梦想，有斗志，有青春，有想念的人。
     * text : 1、一个可怕的传说
     ...
     我劝他不要乱来，毕竟我们都是朋友，怎么突然就要决斗起来了？我真的想不明白。可是我并没有劝住陈奇，他扔下烟蒂，便急匆匆地赶回了学校。他回到教室，看到秋不在教室里，便问其他同学秋在那里，得知秋上了厕所后，他又赶去厕所。陈奇在厕所里叫秋的名字，得到回答后，他拿起角落里的一个拖把直直地扔下了那个厕所隔间。
     ...
     (完)
     * image :
     * publishtime : 636016320000000000
     * status : 0
     * errMsg : null
     */
